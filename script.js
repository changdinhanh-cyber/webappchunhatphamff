...
window.onload = function() {
    ...
    checkWalletState(); 
    loadFavorites(); // Tải trạng thái yêu thích file FF
};
...
// ==========================================
// 7. ĐIỀU HƯỚNG CÁC TRANG (TỪ HUB VÀO APP)
// ==========================================
...
// ==========================================
// 8. LOGIC APP LẤY DPI CHUYÊN NGHIỆP (CÓ CHUYỂN HƯỚNG ADS)
// ==========================================
let selectedOS = 'ios';
...
// ==========================================
// 10. CHỨC NĂNG APP CŨ (chunhatphamff) & CÁC HÀM PHỤ
// ==========================================
